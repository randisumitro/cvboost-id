            ...
            <article class="blog-post">
                <header class="mb-4">
                    ...
                    <div class="d-flex align-items-center text-muted mb-4">
                        <img src="{{ asset('images/author-avatar.jpg') }}" alt="Author" class="rounded-circle me-3" width="40">
                        <div>
                            <div>{{ $post['author'] }}</div>
                ...
                <!-- Featured Image -->
                <div class="mb-4">
                    <img src="{{ asset('images/blog/' . $post['slug'] . '.jpg') }}" 
                         alt="{{ $post['title'] }}" 
            ...
            <div class="card mt-5">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <img src="{{ asset('images/author-avatar.jpg') }}" alt="Author" class="rounded-circle me-3" width="60">
                        <div>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="card">
                            <div class="row g-0">
                                <div class="col-4">
                                    <img src="{{ asset('images/blog/resume-formatting.jpg') }}" 
                                         alt="Related article" 
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="row g-0">
                                <div class="col-4">
                                    <img src="{{ asset('images/blog/resume-mistakes.jpg') }}" 
                                         alt="Related article" 
                                         class="img-fluid rounded-start h-100 object-fit-cover">
                                </div>
                                <div class="col-8">
